...
function toggleElement(card, targetDegrees) {
  ...
  card.style.transform = "rotateY(" + targetDegrees + "deg)";
  card.style.webkitTransform = "rotateY(" + targetDegrees + "deg)";
  
  updateShadows(card, card.style.transition, card.style.transform, duration);
}
